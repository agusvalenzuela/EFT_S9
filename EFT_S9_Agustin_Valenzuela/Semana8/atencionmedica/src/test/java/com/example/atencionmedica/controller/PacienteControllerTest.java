...
public class PacienteControllerTest {
    ...
    public void obtenerTodosTest() throws Exception{
        ...
        paciente2.setPacientecorreo("acontreras@gmail.com");
        paciente2.setPacientegenero("M");
        paciente2.setPacienteprevision("Fonasa");
        paciente2.setPacienterut(145698723);
        paciente2.setPacientedireccion("Los Lirios 17");
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/pacientes"))
									...
									.andExpect(MockMvcResultMatchers.jsonPath("$._embedded.pacienteList[0].pacientenombre", Matchers.is("Alicia Castro")))
									.andExpect(MockMvcResultMatchers.jsonPath("$._embedded.pacienteList[1].pacientenombre", Matchers.is("Andrés Contreras")));
    }
}
